...
- Access to a meshStack workspace that has the [Platform Builder enabled](/guides/platform-ecosystem/how-to-enable-a-new-platform-team).  
...
6. **Entering Terraform implementation details**
   ...
   - Enable the option “Use meshStack’s Http Backend” if using our template.
     Learn more about how this meshStack backend works [here](guides/core/how-to-launch-a-new-terraform-building-block#meshStack-built-in-http-backend).
