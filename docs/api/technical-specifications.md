...
| `size`    | The amount of elements in a single page (default = {default-page-size}). **Note:** You can size up to {max-page-size}. Greater values will be automatically lowered to this value. |
