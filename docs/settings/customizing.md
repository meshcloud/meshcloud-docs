...
Note that platform engineers can also use [the Communication Center](../concepts/communication.md) as an alternative to target messages only at users that consume a specific cloud platform.
