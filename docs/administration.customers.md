...
As a partner user you can assign yourself a role on managed customer accounts. The role that will be assigned depends
on whether Customer Admin assignment is restricted in the panel ([read more here](meshstack.configuration.md#customer-user-invitations)).
