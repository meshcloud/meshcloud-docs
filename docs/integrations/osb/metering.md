...
and generate a [Tenant Usage Report](../../concepts/cost-management.md) for each OSB Services Platform used in a meshProject.
...
Metering & Usage information for Service Owners is available for your Service Brokers from the "Service Broker" tab in your [workspace control plane](../../concepts/workspace.md).
