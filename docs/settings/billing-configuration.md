...
Each project in meshStack is associated with a Chargeback Account. meshStack periodically generates [chargeback statements](/new-concept-cost-management#chargeback-statements).
...
It is also possible to derive [meshTags](/new-concept-tag) as metadata keys by using its tag name.
...
> If you are interested in including budgeting into your chargeback process, have a look at the use of [payment methods](/new-concept-payment-methods).
