...
Note that platform engineers can also use [the Communication Center](/new-concept-communication) as an alternative to target messages only at users that consume a specific cloud platform.
