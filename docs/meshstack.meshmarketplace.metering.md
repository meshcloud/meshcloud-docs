...
and generate a [Tenant Usage Report](meshcloud.cost-management) for each OSB Services Platform used in a meshProject.
...
[meshStack metering product catalog](meshstack.billing#defining-a-custom-product-catalog).
...
Metering & Usage information for Service Owners is available for your Service Brokers from the "Service Broker" tab in your [workspace control plane](meshcloud.workspace#managing-your-meshworkspace).
