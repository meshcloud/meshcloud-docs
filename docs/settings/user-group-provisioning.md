...
1. [Enable SCIM](settings/user-group-provisioning.md#enable-scim) in meshStack.
...
3. In the EA set up the meshStack endpoint as target API:
   ...
   3. Create an [API user](/guides/core/how-to-manage-api-users) with permission `Use all SCIM endpoints provided by meshStack` in meshStack.
