...
|     Azure     | [Microsoft Entra ID B2B](meshstack.azure.index.md#microsoft-entra-id-integration) | [supported](meshstack.azure.index.md#microsoft-entra-id-integration) |
...
let Replicator =
    {-
      aadUserLookupStrategy:
        ...
        This setting is shared across all Azure and meshMarketplace platforms configured to use Microsoft Entra ID
